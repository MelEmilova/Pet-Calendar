...
import animals from './img/We-need-to-talk-about-pets.jpg';


function App() {
  return (
    <div id="container" styles={{ backgroundImage: `url(${animals})` }}>
      <Header></Header>
     ...
     <Switch>
       <Route path="/" exact component={Categories}></Route>
        ...
        <Route path="/catrgories/all" component></Route>
        <Route path="/categories/cats" component></Route>
        <Route path="/categories/dogs" component></Route>
        <Route path="/categories/parrots" component></Route>
        <Route path="/categories/reptiles" component></Route>
        <Route path="/categories/other" exact component></Route>

        <Route path="/:idPet" component={Details}></Route>
